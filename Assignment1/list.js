let changeNumPage = function (){
	var selNumPage = document.getElementById("setNumPage");
    ...
    function Pagination() {
	  ...
	  let current_page = 1;
		...
		console.log(changeNumPage());
      let records_per_page = changeNumPage();
      ...
      let changePage = function(page) {
          ...
          for(var i = (page - 1) * records_per_page; i < (page * records_per_page) && i < objJson.length; i++) {
              ...
              pageNumber.innerHTML += "<span class='clickPageNumber'>" + current_page + "</span>";
          }
          checkButtonOpacity();
          selectedPage();
      }
	  ...
	  let lastPage = function(){
		  current_page=Math.ceil(objJson.length/changeNumPage())
